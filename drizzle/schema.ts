...
export const volunteerRole = pgEnum("volunteer_role", [
  "mentor",
  "guest_speaker",
  "flexible",
  "staff",
...
export const adminDashboardActions = pgTable(
...
export const volunteers = pgTable(
  ...
  (table) => [unique("volunteers_email_unique").on(table.email)],
);
...
export const opportunityInterests = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.opportunityId, table.interestId],
      name: "opportunity_interests_opportunity_id_interest_id_pk",
    }),
  ],
);
...
export const opportunityRequiredSkills = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.opportunityId, table.skillId],
      name: "opportunity_required_skills_opportunity_id_skill_id_pk",
    }),
  ],
);
...
export const volunteerInterests = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.volunteerId, table.interestId],
      name: "volunteer_interests_volunteer_id_interest_id_pk",
    }),
  ],
);
...
export const volunteerSkills = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.volunteerId, table.skillId],
      name: "volunteer_skills_volunteer_id_skill_id_pk",
    }),
  ],
);
...
export const volunteerRsvps = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.volunteerId, table.opportunityId],
      name: "volunteer_rsvps_volunteer_id_opportunity_id_pk",
    }),
  ],
);
